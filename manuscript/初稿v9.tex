...
The complete analysis code, trained model artefacts, and supplementary data files are publicly available at \url{https://github.com/[username]/wids2026-wildfire-survival}.
...
\dataavailability{The dataset used in this study is publicly available through the WiDS 2026 Datathon competition platform (\url{https://www.wids.io}). The analysis code, trained model artefacts, and supplementary data files are available at \url{https://github.com/[username]/wids2026-wildfire-survival} (DOI to be assigned upon acceptance). All random seeds and environment specifications are documented in the repository README to support full reproducibility.}
